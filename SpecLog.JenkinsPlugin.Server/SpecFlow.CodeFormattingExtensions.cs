/* This file was copied from the TechTalk.SpecFlow source tree from GitHub (at 8b4cb4c)    */
/* https://raw.github.com/techtalk/SpecFlow/master/Generator/FeatureFileInputExtensions.cs */
/* This is how SpecFlow format free text into test class and test method names.            */
...
namespace TechTalk.SpecFlow
{
    ...
    {
        public static string AsFeatureId(this string title)
        {
            return ToIdentifier(title) + "Feature";
        }

        public static string AsScenarioId(this string title)
        {
            return ToIdentifier(title);
        }
